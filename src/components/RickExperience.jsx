...
export const RickExperience = () => {
    const [animation, setAnimation] = useState("Armature|mixamo.com|Layer0");
 ...
 <Canvas camera={{ position: [0, 0, 15], fov: 45 }} >
        ...
        <group rotation-y={degToRad(50)} position-x={0} position-y={-4.5}>
        <OrbitControls
    ...
    />
       <Soldier scale={5} animation={animation}/>
